...
$sql = "select distinct symptom from medicine where subcat ='".$_SESSION['subcat']."'";
...
<div class = "col-md-4">
<h4 style="color:black">Select the SYMPTOM of the problem:</h4>
...
if(isset($_POST['submit'])){
    ...
    $_SESSION['symptom'] = $selected_val;
    header("Location:finalmed.php");
}
